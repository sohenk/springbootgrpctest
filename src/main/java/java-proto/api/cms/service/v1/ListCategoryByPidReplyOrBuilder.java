...
public interface ListCategoryByPidReplyOrBuilder extends
    // @@protoc_insertion_point(interface_extends:api.cms.service.v1.ListCategoryByPidReply)
   ...
   */
  java.util.List<api.cms.service.v1.Category> 
      getListList();
  /**
   * <code>repeated .api.cms.service.v1.Category list = 3;</code>
   */
  api.cms.service.v1.Category getList(int index);
  /**
   * <code>repeated .api.cms.service.v1.Category list = 3;</code>
   */
  int getListCount();
   ...
   * <code>repeated .api.cms.service.v1.Category list = 3;</code>
   */
  java.util.List<? extends api.cms.service.v1.CategoryOrBuilder> 
      getListOrBuilderList();
  /**
   * <code>repeated .api.cms.service.v1.Category list = 3;</code>
   */
  api.cms.service.v1.CategoryOrBuilder getListOrBuilder(
      int index);
